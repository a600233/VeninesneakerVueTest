    ...
    <b-navbar toggleable="md" variant="dark" type="dark">
      ...
      <b-collapse is-nav id="nav_collapse">
        <b-navbar-nav>
          ...
          <b-nav-item to="/selling"><i class="fa fa-list" style="padding: 5px"> Selling</i></b-nav-item>
          <b-nav-item to="/sell"><i class="fa fa-money" style="padding: 5px"> Sell</i></b-nav-item>
          <b-nav-item><i class="fa fa-globe" style="padding: 5px"> Map</i></b-nav-item>
        </b-navbar-nav>
